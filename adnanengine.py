...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        logo = QLabel()
        logo.setPixmap(QPixmap(os.path.join('images', 'aeo.jpg')))
        layout.addWidget(logo)

        layout.addWidget(QLabel("Version 1.1"))
        layout.addWidget(QLabel("Copyright."))
        layout.addWidget(QLabel("Made by Adnan Encoding Oranization"))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.browser.setUrl(QUrl("https://adnanengine.000webhostapp.com"))
        ...
        stop_btn = QAction(QIcon(os.path.join('images', 'search.png')), "Search", self)
        stop_btn.setStatusTip("Search Here")
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - Adnan Encoding Engine" % title)

    def navigate_mozarella(self):
        self.browser.setUrl(QUrl("https://sites.google.com/view/adnan-company"))
...
app.setApplicationName("Adnan Engine")
app.setOrganizationName("Adnan Encoding Oraganization")
app.setOrganizationDomain("adnanencodingorg.tk")
